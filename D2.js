...
if (totalShoppingCart >= 50) {
  console.log("Sconto spedizione applicato " + (totalShoppingCart - spedizione))
}
else {
...
let totaleSenzaspedizione = (totalShoppingCart - spedizione);
let totaleConspedizione = (totalShoppingCart + spedizione);
